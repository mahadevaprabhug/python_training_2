...
In this section,
1. Encapsulation: keep data and related methods/variables together OR in one box/container/bag
2. Abstraction: Achieving this through methods where we are just knowing
                how to use methods instead of how it is implemented
"""
...
print("METHODS/VARIABLES inside object")
print("-"*20)
# --------------
